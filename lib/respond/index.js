...
var getRequestUrl = require('../utils/request-url')
...
function responder(req, res, unpm) {
  ...
  var host = unpm.config.host
  respond.originalRequestUrl = getRequestUrl(req, host.hostname, host.port, host.protocol)
